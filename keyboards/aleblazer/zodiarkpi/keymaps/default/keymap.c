...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
      ...
      KB_MODE0,  KB_MODE1,    KB_MODE2,     KB_MODE3,  KC_GRV,          KC_TAB,          KC_SLEP,          KC_ENT,            KC_SPC,            KC_LEFT,     KC_UP,       KC_DOWN,    KC_RGHT,    KC_BSLS
    ),

	[1] = LAYOUT(
      KC_ESC,    KC_F1,       KC_F2,        KC_F3,     KC_F4,      KC_F5,                                                            KC_F6,      KC_F7,       KC_F8,       KC_F9,      KC_F10,     KC_BSPC,
      _______,   _______,     _______,      KB_MODE0,  KB_MODE2,   _______,                                                          KC_NUM,     KC_P7,       KC_P8,       KC_P9,      _______,    KC_F11,   
      KC_CAPS,   _______,     _______,      KB_MODE1,  KB_MODE3,   _______,  _______,    _______,          _______,     _______,     KC_PSLS,    KC_P4,       KC_P5,       KC_P6,      _______,    KC_F12,
	...
	[3] = LAYOUT(
      ...
      _______,   KB_MODE0,    KB_MODE2,     _______,   _______,    _______,  _______,    _______,          _______,     _______,     _______,    RGB_TOG,     _______,     _______,    _______,    _______,
      _______,   KB_MODE1,    KB_MODE3,     _______,   _______,    _______,  _______,    _______,          _______,     _______,     _______,    RGB_MOD,     RGB_SPI,     RGB_HUI,    RGB_SAI,    RGB_VAI,
