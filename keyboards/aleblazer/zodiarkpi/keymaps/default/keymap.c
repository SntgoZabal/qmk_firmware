...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
      ...
      SCR_LOCK,  KC_Q,     KC_W,      KC_E,      KC_R,       KC_T,                                                             KC_Y,       KC_U,        KC_I,        KC_O,       KC_P,       KC_LBRC,
	...
	[1] = LAYOUT(
      ...
      KC_PSLS,   KC_P7,    KC_P8,     KC_P9,     _______,    _______,                                                          KC_NUM,     KC_P7,       KC_P8,       KC_P9,      _______,    KC_F12,   
      KC_CAPS,   KC_P4,    KC_P5,     KC_P6,     _______,    _______,  _______,    _______,          _______,     _______,     KC_PSLS,    KC_P4,       KC_P5,       KC_P6,      _______,    _______,
      _______,   KC_P1,    KC_P2,     KC_P3,     _______,    _______,  _______,    _______,          _______,     _______,     _______,    KC_P1,       KC_P2,       KC_P3,      _______,    _______,
      _______,   KC_P0,    KC_PDOT,   KC_PENT,   _______,         _______,         _______,          _______,           _______,           KC_P0,       KC_PDOT,     KC_PENT,    _______     _______,
      ),
