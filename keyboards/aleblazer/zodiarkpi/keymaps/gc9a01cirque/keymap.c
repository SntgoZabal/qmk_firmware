...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
      ...
      _______,   _______,     _______,      _______,   _______,    _______,  KC_LGUI,    _______,          _______,     _______,     _______,    _______,     _______,     _______,    _______,               _______,
      KB_MODE0,  KB_MODE1,    KB_MODE2,     KB_MODE3,  _______,         _______,         KC_LCTL,          _______,           _______,           _______,     _______,     _______,    _______,               _______
      ),
	...
	[2] = LAYOUT(
      ...
      _______,   _______,     _______,      _______,   _______,    _______,  _______,    _______,          MS_LEFT,     MS_RGHT,     _______,    KC_P1,       KC_P2,       KC_P3,      KC_KP_PLUS,            _______,
